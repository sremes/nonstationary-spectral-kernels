function y = logmvnpdf(X, Mu, Sigma, is_chol)
%LOGMVNPDF Multivariate normal log probability density function (pdf).
...
% Provided with a Cholesky of the covariance matrix
elseif nargin > 3 && is_chol
    xRinv = X0 / Sigma; 
    logSqrtDetSigma = sum(log(diag(Sigma)));
